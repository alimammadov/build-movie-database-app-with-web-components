const movieTemaplate = document.createElement('template')

movieTemaplate.innerHTML = `
<style>
...
class MovieCard extends HTMLElement {
    constructor() {
        ...
        this.shadowRoot.appendChild(movieTemaplate.content.cloneNode(true))
        // Attribute melumatlarini oxumaq
        setTimeout(() => {
